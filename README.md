...
```
*В дальнейшем для запуска программы просто введите команду `amnezia` в терминале.*
...
> После первой установки (с интернетом), все графические и логические узлы приложения устанавливаются в вашу систему глобально (в `~/.amnezia-v2`). Теперь вы можете управлять вашими серверами локально командой `amnezia` без интернета! А при выходе новой версии вы можете обновиться прямо через пункт **«Проверить обновления»** в меню программы.
